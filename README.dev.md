# `mypkg18` developer documentation
...
# install mypkg18 as an editable package
...
The second is to use `tox`, which can be installed separately (e.g. with `pip install tox`), i.e. not necessarily inside the virtual environment you use for installing `mypkg18`, but then builds the necessary virtual environments itself by simply running:
...
cd $(mktemp -d mypkg18.XXXXXX)
git clone git@github.com:abel/mypkg18 .
...
Visit
[https://test.pypi.org/project/mypkg18](https://test.pypi.org/project/mypkg18)
and verify that your package was uploaded successfully. Keep the terminal open, we'll need it later.

In a new terminal, without an activated virtual environment or an env directory:

```shell
cd $(mktemp -d mypkg18-test.XXXXXX)
...
--extra-index-url https://pypi.org/simple mypkg18
```
...
Don't forget to also make a [release on GitHub](https://github.com/abel/mypkg18/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.